...
session_types   = {'baseline', 'AP', 'AP2', ...                             %these will be used as suffix identifiers
                   ...
                   'contra_puff', 'AnBaseline', 'AnAP', 'AnAP2' };                          % extras are buffers for additional session types - or different baselines. You can add as many additional session types as you want.
                                                                            % Rename them to relevant descriptor.                                                                           
use_sessions    = [ 1 4 ];% 2  3 4 5 6 7];                                     % Which session types to use out of above 'session_types'
nSess           = numel(use_sessions);
%%
% what video segments
exp.Video.Segments = { 'laser_bcam', 'led_bcam', 'whiskpadR_bcam', 'wheel_bcam', 'eye_bcam', 'led_ucam', 'ear_ucam', 'whiskpadR_fcam' }; %'whiskpadR_fcam',, 'forelimb_ecam', 'bodywheel_bcam', 'wheelMI_ecam', 'forelimb_ecam' ,'whiskpadL_ecam','whiskpadR_ecam','forepawR_ecam', 'whiskpadR_ecam', should be cropped tifs, and suffix indicates camera for timefile.
exp.Video.ROI = { [39,33,517,57], [30,22,347,0], [54,61,507,265], [69,55,120,396], [42,48,503,165], [38,38,537,144], [89,104,380,211], [323,238,228, 163]  }; %, [140,243,1136,717], [536,152,85,634] 
...
exp.Folder.Session  = 'win 129/exp 01/';                     %which experiment/animal/session folder?
...
exp.ID              = '201218_14_20_54';                                    %Unique ID - Usually represents baseline/ROI/zstack used.
exp.AnimalID        = 0129;                                                 %100N= HG 00N || PIL 1 = Harsha/PIL 2= Fred, 00N = animal number (Harsha's scheme)
exp.Animal          = 'Win 129';
exp.user            = 'Harsha';
...
exp.Folder.baseline = '201218_14_20_54 FunctAcq';                           %baselines can be different for different exp types
exp.Folder.AP       = '';%180409_11_55_20 FunctAcq';   %'180423_12_24_57 FunctAcq'
exp.Folder.AP2      = '';   %'180423_12_29_10 FunctAcq';                    
exp.Folder.baseline2= '201218_14_32_32 FunctAcq';   %'180423_12_38_00 FunctAcq';
...
exp.Folder.baseline4= '';
exp.Folder.ido      = '';

% Video data
exp.VideoFolder.baseline = '201218_14_20_54 FunctAcq VidRec/201218_14_20_54 FunctAcq VidRec';%180827_11_49_28 VidRec
exp.VideoFolder.AP       = '';
exp.VideoFolder.AP2      = '';
exp.VideoFolder.baseline2= '201218_14_32_32 FunctAcq VidRec/201218_14_32_32 FunctAcq VidRec';
...
Loco.on_threshold          = 0.4;
Loco.off_threshold         = 0.1;
...
Whisk.on_threshold          = 0.135;
Whisk.off_threshold         = 0.13;
