...
get_corr    = false;                                                         % Pairwise and behavioural correlations of dF/F
...
exp.Video.ROI = { [88,74,488,228], [168,34,13,444], [15,22,266,22], [17,21,344,164], [40,20,590,181], [337,195,184,15], [543,157,8,306]  }; %, [140,243,1136,717], [536,152,85,634] 
...
exp.Folder.Session  = 'HG 33 Martha Chase win 121/exp 04/';                     %which experiment/animal/session folder?
...
exp.ID              = '210101_12_19_15';                                    %Unique ID - Usually represents baseline/ROI/zstack used.
exp.AnimalID        = 1033;                                                 %100N= HG 00N || PIL 1 = Harsha/PIL 2= Fred, 00N = animal number (Harsha's scheme)
exp.Animal          = 'HG 33 Martha Chase';
exp.user            = 'Harsha';
...
exp.Folder.baseline = '210101_12_19_15 FunctAcq';                           %baselines can be different for different exp types
exp.Folder.AP       = '';%'201205_16_58_31 FunctAcq';%180409_11_55_20 FunctAcq';   %'180423_12_24_57 FunctAcq'
exp.Folder.AP2      = '';%'201205_17_10_21 FunctAcq';   %'180423_12_29_10 FunctAcq';                    
exp.Folder.baseline2= '210101_12_29_43 FunctAcq';   %'180423_12_38_00 FunctAcq';
...
% Video data
exp.VideoFolder.baseline = '210101_12_19_15 FunctAcq VidRec/210101_12_19_15 FunctAcq VidRec';%180827_11_49_28 VidRec
...
exp.VideoFolder.baseline2= '210101_12_29_43 FunctAcq VidRec/210101_12_29_43 FunctAcq VidRec';%'180827_12_03_53 VidRec';%'videos/180423_12_40_13';
...
Whisk.on_threshold          = 0.15;
Whisk.off_threshold         = 0.145;
