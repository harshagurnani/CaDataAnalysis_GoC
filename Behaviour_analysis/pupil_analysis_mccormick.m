% function pupil = pupil_analysis_mccormick( threshDark )
%% Adapted from Pupil Analysis of McCormick's lab
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% README
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Load data
% cd 'F:\Golgi in vivo imaging\Raw Data\FL 90\exp 01\180316_16_36_12 VidRec\pupil'
% yourFolder = 'D:\myStuff\pupil data\Pupil data';
% addpath(yourFolder);

% place files in natural order
use_tiffile = true;
if use_tiffile, contents = dir('*pupil*.tif'); end
...
if ~use_tiffile,contents = dir('*.jpg');
...
animal_id = 'HG 28';%str2double(animal_id');
